...
import { ArrowLeft, Star, Shield, Truck, Clock, Bell, Package, Calendar, TrendingUp, ShoppingCart } from "lucide-react"
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                    <span className="text-gray-700">Professional medical consultation included</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  ...
                  <li className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                    <span className="text-gray-700">Fast delivery to your doorstep</span>
                  </li>
                </ul>
              </div>
              ...
              {/* Buy Now Button */}
              <div className="space-y-4">
                <Link href={`/checkout?productId=${product.id}&name=${encodeURIComponent(product.name)}&price=${product.price}&category=${encodeURIComponent(product.category)}`}>
                  <Button 
                    className="w-full bg-primary hover:bg-blue-600 text-white py-4 text-lg font-semibold"
                    disabled={product.available_stock === 0}
                  >
                    <ShoppingCart className="w-5 h-5 mr-2" />
                    {product.available_stock > 0 ? `Buy Now - ${formatPrice(product.price)}` : "Out of Stock"}
                  </Button>
                </Link>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  <p className="text-gray-700">
                    Our process ensures you receive the highest quality care and medication:
                  </p>
                  <ul className="space-y-2 text-gray-700">
                    <li>• Complete a comprehensive medical consultation</li>
                    <li>• Our licensed healthcare providers review your information</li>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  <p className="text-gray-700 text-sm">
                    <strong>Important:</strong> This medication requires a prescription and medical consultation. 
                    Please consult with our healthcare providers before starting any treatment.
                  </p>
                  <p className="text-gray-700 text-sm">
                    Common side effects may include nausea, headache, and mild gastrointestinal symptoms. 
                    Most side effects improve over time.
                  </p>
                  <p className="text-gray-700 text-sm">
                    Do not use if you are allergic to any of the ingredients or have certain medical conditions.
                  </p>
                </div>
              </CardContent>
            </Card>
