...
import { User, MapPin, MessageCircle, ShoppingCart, Mail, X, Star, Bell, AlertTriangle } from "lucide-react"
            ...
            <Card>
              <CardContent className="p-8">
                <div className="flex items-center justify-between mb-8">
                  <h1 className="text-2xl font-semibold text-gray-900">Order Query</h1>
                ...
                <Alert className="border-yellow-200 bg-yellow-50">
                  ...
                  <AlertDescription className="text-yellow-800">You don't have open tickets</AlertDescription>
                </Alert>
              </CardContent>
            </Card>
          </div>
