...
import { User, MapPin, MessageCircle, ShoppingCart, Mail, X, Star, Bell, AlertTriangle, Eye, CheckCircle, Clock } from "lucide-react"
import Link from "next/link"
import Image from "next/image"
import Logout from "@/components/logout/Logout"
import { getUserSupportTickets, getUserSupportTicketById, replyToUserSupportTicket } from "@/lib/api/supportTicketService"
...
export default function SupportPage() {
  ...
  const handleReply = async () => {
    ...
    try {
      await replyToUserSupportTicket(selectedTicket.id, replyMessage, replyFiles)
              ...
              <CardContent className="p-8">
                <div className="flex items-center justify-between mb-8">
                  ...
                  <Link href="/dashboard/support/create-ticket">
                    <Button className="bg-primary hover:bg-blue-600 text-white">Create ticket</Button>
                  </Link>
                </div>
                ...
                {loading ? (
                  ...
                  <Alert className="border-yellow-200 bg-yellow-50">
                    ...
                    <AlertDescription className="text-yellow-800">You don't have any support tickets</AlertDescription>
                  </Alert>
                ) : (
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Badge className={getStatusColor(selectedTicket.priority)}>{selectedTicket.priority}</Badge>
                    </div>
                    <div>
